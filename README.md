...
### Files in this Repository
    ...
    ├── Report.md                        # report of the implementation and details of the learning algorithm
    ├── checkpoint.pth     # stored weights of trained network (1000 iterations, 2 hidden 64 unit layers)
    └── README.md
